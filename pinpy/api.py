...
class API(object):
	...
	def get_user(self, user_id):
		...
		# print(request_url)
		return pinpy.User(self.call(request_url)['data'])
	...
	def get_public_pin(self, pin_id):
		...
		request_url = request_url.rstrip('%2C')
		# print(request_url)
		return pinpy.Pin(self.call(request_url)['data'])
	...
	def get_public_board(self, board_id):
		...
		json_data = self.call(request_url)['data']
	...
	def get_public_board_pins(self, board_id, cursor=None):
		...
		if cursor:
			...
			return pinpy.BoardPins(self.call(request_url), board_id, self)
	...
	def get_public_board_pins_v3(self, board_id, bookmark=None, page_size=100):
		...
		if bookmark:
			...
			return pinpy.BoardPinsV3(self.call(request_url), board_id, self)
	...
	def get_public_pin_v3(self, pin_id):
		...
		# print(request_url)
		return pinpy.PinV3(self.call(request_url)['data'])
	...
	def get_user_followers_v3(self, user_id, bookmark=None, page_size=100):
		...
		if bookmark:
			...
			request_url = "{}?page_size={}&access_token={}".format(api_endpoint, page_size, self.v3_access_token)
			return pinpy.UserFollowersV3(self.call(request_url), user_id, self.get_user_followers_v3)
	...
	def get_user_following_v3(self, user_id, bookmark=None, page_size=100):
		...
		if bookmark:
			...
			request_url = "{}?page_size={}&access_token={}".format(api_endpoint, page_size, self.v3_access_token)
			return pinpy.UserFollowingV3(self.call(request_url), user_id, self.get_user_following_v3)
	...
	def get_user_pins_v3(self, user_id, bookmark=None, page_size=100):
		...
		if bookmark:
			...
			request_url = "{}?page_size={}&access_token={}".format(api_endpoint, page_size, self.v3_access_token)
			return pinpy.UserPinsV3(self.call(request_url), user_id, self.get_user_pins_v3)
	...
	def get_pin_comments_v3(self, pin_id, bookmark=None, page_size=100):
		...
		if bookmark:
			...
			request_url = "{}?page_size={}&access_token={}".format(api_endpoint, page_size, self.v3_access_token)
			return pinpy.PinCommentsV3(self.call(request_url), pin_id, self.get_pin_comments_v3)
