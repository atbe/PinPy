...
class TestPinModel(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.api = pinpy.API(os.environ['PIN_TOKEN'])
    ...
    def test_constructor(self):
        ...
        self.assertIsInstance(self.pin, pinpy.Pin, msg='Pin should be type pypin.models.Pin')
...
class TestUserModel(unittest.TestCase):
    ...
    def test_constructor(self):
        # TODO: Remove the hardcoded sample Pin and use some sort of cassettes.
        self.assertIsInstance(self.user, pinpy.User, msg='Pin should be type pypin.models.Pin')
...
class TestBoardModel(unittest.TestCase):
    ...
    def test_constructor(self):
        # TODO: Remove the hardcoded sample Pin and use some sort of cassettes.
        self.assertIsInstance(self.board, pinpy.Board, msg='Board should be type pypin.models.Board')
        self.assertIsInstance(self.board.creator, pinpy.User, msg='Boards creator should be type pypin.models.User')
...
class TestBoardPinsModel(unittest.TestCase):
    ...
    def test_constructor(self):
        # TODO: Remove the hardcoded sample Pin and use some sort of cassettes.
        self.assertIsInstance(self.board_pins, pinpy.BoardPins, msg='BoardPins should be type pypin.models.BoardPins')
    ...
    def test_board_pins_iter(self):
        ...
        for pin in self.board_pins:
            c += 1
            self.assertIsInstance(pin, pinpy.Pin, msg='Iterating over BoardPins should return Pins.')
